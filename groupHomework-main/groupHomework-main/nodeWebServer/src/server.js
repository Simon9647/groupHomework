...
function init() { //populate the map with some initial data
    let student1 = { id: 1, firstName: "Alice", lastName: "Johnson", age: 20, major: "Computer Science" };
    let student2 = { id: 2, firstName: "Bob", lastName: "Smith", age: 22, major: "Mathematics" };
    ...
    let student5 = { id: 5, firstName: "Eve", lastName: "Davis", age: 20, major: "Biology" };
    let student6 = { id: 6, firstName: "Frank", lastName: "Miller", age: 22, major: "Engineering" };
    let student7 = { id: 7, firstName: "Grace", lastName: "Taylor", age: 21, major: "Economics" };
    let student8 = { id: 8, firstName: "Heidi", lastName: "Anderson", age: 23, major: "Philosophy" };
    let student9 = { id: 9, firstName: "Ivan", lastName: "Martinez", age: 20, major: "Art History" };
    let student10 = { id: 10, firstName: "Judy", lastName: "Thompson", age: 22, major: "Political Science" };
...
app.get('/search', (req, res) => {
    ...
    for (let i = 0; i < students.length; i++) {
        let n = students[i].firstName.toLowerCase();
        if ((n === firstName.toLowerCase())) {
            student = students[i];
            foundStudents.push(student);
        }
        else {
            if (n.includes(firstName.toLowerCase())) {
                student = students[i];
                foundStudents.push(student);
            }
            else {
                if (n.startsWith(firstName.toLowerCase())) {
                    student = students[i];
                    foundStudents.push(student);
                }
                else {
                    if (n.endsWith(firstName.toLowerCase())) {
                        student = students[i];
                        foundStudents.push(student);
                    }
                }
